    ...
    <div className="font-primary md: flex items-center justify-between border-gray-300 px-8 py-5 md:border-b-1">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="pb-1 text-5xl font-bold text-gray-800">
      ...
      <div className="flex items-center justify-between gap-6">
        {itemCount > 0 ? (
          <div
            className="relative flex cursor-pointer items-center justify-between gap-4 p-4"
            onClick={toggleCart}
          >
            <img src={cartIcon} alt="cart" className="h-5 w-5 md:h-5 md:w-5" />
            <span className="absolute bottom-2/3 left-1/2 flex h-4 w-6 items-center justify-center rounded-lg bg-amber-500 text-xs font-bold text-white">
              {itemCount}
            </span>
          </div>
        ) : (
        ...
        {isCartOpen && (
          <div className="absolute top-25 left-1/2 z-10 w-[95%] -translate-x-1/2 shadow-lg md:top-20 md:right-60">
